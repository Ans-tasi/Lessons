...
public class PayFrameMtsTests {
    public static WebDriver driver;
    public static MTS mts;
    public static PayFrameMts payFrame;
    ...
    static void before() {
        ...
        mts.setConnectionPhone(TEST_PHONE_NUMBER);
        mts.setConnectionSum(TEST_SUM);
        mts.clickButton();
        payFrame = new PayFrameMts(driver, mts.payFrame);
    }
    @AfterAll
    static void after() {
        driver.quit();
